 ...
 */
@ApiModel(description = "An object describing the service, its pricing and its availability.")
...
public class InlineResponse2003PropertyServiceList {
  /**
  ...
  private List<FeatureListEnum> featureList = new ArrayList<FeatureListEnum>();
  ...
  private List<TypeListEnum> typeList = new ArrayList<TypeListEnum>();
  ...
  private List<ItemListEnum> itemList = new ArrayList<ItemListEnum>();
  ...
  private List<InlineResponse2003PropertyOperationTimeList> operationTimeList = new ArrayList<InlineResponse2003PropertyOperationTimeList>();

  public static final String SERIALIZED_NAME_NAME = "name";
  @SerializedName(SERIALIZED_NAME_NAME)
  private String name;

  public InlineResponse2003PropertyServiceList() { 
  }

  public InlineResponse2003PropertyServiceList code(CodeEnum code) {
  ...
  **/
  ...
  @ApiModelProperty(example = "173", required = true, value = "The code of this service<p>See also <a href=\"#servicecodes\">in the appendix</a>.</p>")
  ...
  public InlineResponse2003PropertyServiceList price(BigDecimal price) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "19.99", required = true, value = "The surcharge for this service.")
  ...
  public InlineResponse2003PropertyServiceList exists(Boolean exists) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "true", required = true, value = "Whether this service is available.")
  ...
  public InlineResponse2003PropertyServiceList included(Boolean included) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "false", required = true, value = "Whether this service is complementary.")
  ...
  public InlineResponse2003PropertyServiceList currencyCode(String currencyCode) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "EUR", required = true, value = "The currency of the surcharge for this service")
  ...
  public InlineResponse2003PropertyServiceList featureList(List<FeatureListEnum> featureList) {
    
    this.featureList = featureList;
    return this;
  }

  public InlineResponse2003PropertyServiceList addFeatureListItem(FeatureListEnum featureListItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "[]", required = true, value = "A list of features.")
  ...
  public InlineResponse2003PropertyServiceList typeList(List<TypeListEnum> typeList) {
    
    this.typeList = typeList;
    return this;
  }

  public InlineResponse2003PropertyServiceList addTypeListItem(TypeListEnum typeListItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of codes describing the available breakfast type.<p>See also <a href=\"#breakfasttype-codes\">in the appendix</a>.</p>")
  ...
  public InlineResponse2003PropertyServiceList itemList(List<ItemListEnum> itemList) {
    
    this.itemList = itemList;
    return this;
  }

  public InlineResponse2003PropertyServiceList addItemListItem(ItemListEnum itemListItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of codes describing the available breakfast items.<p>See also <a href=\"#breakfastitem-codes\">in the appendix</a>.</p>")
  ...
  public InlineResponse2003PropertyServiceList operationTimeList(List<InlineResponse2003PropertyOperationTimeList> operationTimeList) {
    
    this.operationTimeList = operationTimeList;
    return this;
  }

  public InlineResponse2003PropertyServiceList addOperationTimeListItem(InlineResponse2003PropertyOperationTimeList operationTimeListItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "A list of operation times, including start and end times, and the days of the week on which the operation is open.")

  public List<InlineResponse2003PropertyOperationTimeList> getOperationTimeList() {
    return operationTimeList;
  }


  public void setOperationTimeList(List<InlineResponse2003PropertyOperationTimeList> operationTimeList) {
    this.operationTimeList = operationTimeList;
  }


  public InlineResponse2003PropertyServiceList name(String name) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "Breakfast served in restaurant.", required = true, value = "The name of this service.")
  ...
  public boolean equals(Object o) {
    ...
    InlineResponse2003PropertyServiceList inlineResponse2003PropertyServiceList = (InlineResponse2003PropertyServiceList) o;
    return Objects.equals(this.code, inlineResponse2003PropertyServiceList.code) &&
        Objects.equals(this.price, inlineResponse2003PropertyServiceList.price) &&
        Objects.equals(this.exists, inlineResponse2003PropertyServiceList.exists) &&
        Objects.equals(this.included, inlineResponse2003PropertyServiceList.included) &&
        Objects.equals(this.currencyCode, inlineResponse2003PropertyServiceList.currencyCode) &&
        Objects.equals(this.featureList, inlineResponse2003PropertyServiceList.featureList) &&
        Objects.equals(this.typeList, inlineResponse2003PropertyServiceList.typeList) &&
        Objects.equals(this.itemList, inlineResponse2003PropertyServiceList.itemList) &&
        Objects.equals(this.operationTimeList, inlineResponse2003PropertyServiceList.operationTimeList) &&
        Objects.equals(this.name, inlineResponse2003PropertyServiceList.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse2003PropertyServiceList {\n");
