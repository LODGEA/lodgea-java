...
public class PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner {
  /**
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner typeCode(TypeCodeEnum typeCode) {
  ...
  **/
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner percent(BigDecimal percent) {
  ...
  **/
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner chargeType(ChargeTypeEnum chargeType) {
  ...
  **/
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner chargeFrequencyCode(ChargeFrequencyCodeEnum chargeFrequencyCode) {
  ...
  **/
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner currencyCode(CurrencyCodeEnum currencyCode) {
  ...
  **/
  ...
  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner conditionList(List<ConditionListEnum> conditionList) {
    
    this.conditionList = conditionList;
    return this;
  }

  public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner addConditionListItem(ConditionListEnum conditionListItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner = (PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner) o;
    return Objects.equals(this.typeCode, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.typeCode) &&
        Objects.equals(this.percent, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.percent) &&
        Objects.equals(this.chargeType, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.chargeType) &&
        Objects.equals(this.chargeFrequencyCode, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.chargeFrequencyCode) &&
        Objects.equals(this.currencyCode, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.currencyCode) &&
        Objects.equals(this.conditionList, propertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.conditionList);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner is not found in the empty JSON string", PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.class));

       return (TypeAdapter<T>) new TypeAdapter<PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner>() {
           @Override
           public void write(JsonWriter out, PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner
  ...
  */
  public static PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner.class);
  }

 /**
  * Convert an instance of PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerTaxPolicyListInner to an JSON string
  *
  * @return JSON string
  */
