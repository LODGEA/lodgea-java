...
public class AvailabilitySearchPostRequest {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailabilitySearchPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if ((jsonObj.get("unitSystem") != null && !jsonObj.get("unitSystem").isJsonNull()) && !jsonObj.get("unitSystem").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("earliestArrival") != null && !jsonObj.get("earliestArrival").isJsonNull()) && !jsonObj.get("earliestArrival").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("latestReturn") != null && !jsonObj.get("latestReturn").isJsonNull()) && !jsonObj.get("latestReturn").isJsonPrimitive()) {
