...
public class PropertiesPropertyIdGet200ResponseProductListInner {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PropertiesPropertyIdGet200ResponseProductListInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("policyInfo") != null && !jsonObj.get("policyInfo").isJsonNull()) {
